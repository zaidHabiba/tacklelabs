...
from app.controllers.controller_model import create_api, create_io_api, create_model, create_image_model, send_request, fetch_models
urlpatterns = [
    ...
    path("user/<int:user_id>/create_api/", create_api),
